...
void ui_settingscreen_screen_init(void)
{
    ...
    lv_obj_set_height(ui_settingscreenMenu, LV_SIZE_CONTENT); /// 2
    ...
    lv_obj_add_flag(ui_settingscreenMenu, LV_OBJ_FLAG_SCROLL_ON_FOCUS); /// Flags
    ...
    lv_obj_set_width(ui_wifi_setting_label, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_height(ui_wifi_setting_label, LV_SIZE_CONTENT); /// 1
    lv_obj_set_x(ui_wifi_setting_label, -89);
    lv_obj_set_y(ui_wifi_setting_label, -95);
    lv_obj_set_align(ui_wifi_setting_label, LV_ALIGN_CENTER);
    ...
    lv_obj_clear_flag(ui_setting_wifi_state_panel, LV_OBJ_FLAG_SCROLLABLE); /// Flags
    ...
    lv_obj_set_width(ui_setting_wifi_state_label, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_height(ui_setting_wifi_state_label, LV_SIZE_CONTENT); /// 1
