...
void ui_mainscreen_screen_init(void)
{
    ...
    lv_obj_set_width(ui_humiValue, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_height(ui_humiValue, LV_SIZE_CONTENT); /// 1
    ...
    lv_obj_add_flag(ui_measureBTN, LV_OBJ_FLAG_SCROLL_ON_FOCUS); /// Flags
    lv_obj_clear_flag(ui_measureBTN, LV_OBJ_FLAG_SCROLLABLE);    /// Flags
    ...
    lv_obj_clear_flag(ui_resultContainer, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE); /// Flags
    ...
    lv_obj_set_width(ui_resultValue, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_height(ui_resultValue, LV_SIZE_CONTENT); /// 1
    ...
    lv_obj_set_width(ui_error_notify, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_height(ui_error_notify, LV_SIZE_CONTENT); /// 1
    ...
    lv_obj_set_width(ui_titleLabel1, LV_SIZE_CONTENT);  /// 1
    ...
    lv_obj_set_width(ui_titleLabel2, LV_SIZE_CONTENT);  /// 1
    ...
    lv_obj_set_height(ui_mainscreenMenu, LV_SIZE_CONTENT); /// 2
    lv_obj_set_x(ui_mainscreenMenu, 85);
    lv_obj_set_y(ui_mainscreenMenu, 3);
    lv_obj_set_align(ui_mainscreenMenu, LV_ALIGN_TOP_MID);
    lv_obj_add_flag(ui_mainscreenMenu, LV_OBJ_FLAG_SCROLL_ON_FOCUS); /// Flags
    ...
    lv_obj_set_width(ui_measureState, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_height(ui_measureState, LV_SIZE_CONTENT); /// 1
    ...
    lv_obj_add_flag(ui_measureState, LV_OBJ_FLAG_HIDDEN); /// Flags
    ...
    lv_obj_add_flag(ui_loadingSpinner, LV_OBJ_FLAG_HIDDEN);      /// Flags
